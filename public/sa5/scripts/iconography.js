...
// Relative paths: with <base href="{{ url('/') }}/"> in head, json/ -> /json/, sa5/css/ -> /sa5/css/
// public/json/ holds fa-icons.json, fa-mappings.json; sa5 holds css and rest of json
const styleSheets = {
  'sa': null,
  'base': null,
  'svg': null,
  'fal': 'sa5/css/fa-light.css',
  'fas': 'sa5/css/fa-solid.css',
  'far': 'sa5/css/fa-regular.css',
  'fab': 'sa5/css/fa-brands.css',
  'fad': 'sa5/css/duotone.css',
  'material': 'sa5/css/material-icons.css'
};
...
async function loadIconSet(iconSet = 'sa') {
  const iconSets = {
    'sa': {
      icons: 'sa5/json/sa-icons.json',
      mappings: 'sa5/json/sa-mappings.json',
      prefix: 'sa'
    },
    'base': {
      icons: 'sa5/json/sa-base.json',
      mappings: 'sa5/json/sa-mappings.json',
      prefix: 'sa'
    },
    'svg': {
      icons: 'sa5/json/sa-svg-icons.json',
      mappings: 'sa5/json/sa-svg-mappings.json',
      prefix: 'svg'
    },
    'fal': {
    ...
    'fad': {
      icons: 'sa5/json/fa-duotone.json',
      mappings: 'json/fa-mappings.json',
      prefix: 'fad'
    },
    'fab': {
      icons: 'sa5/json/fa-brands.json',
      mappings: 'json/fa-mappings.json',
      prefix: 'fab'
    },
    'material': {
      icons: 'sa5/json/material-icons.json',
      mappings: 'sa5/json/material-mappings.json',
      prefix: 'material'
    }
  };
...
function updateVisibleCount() {
  ...
  if (!el) return;
  const visibleIcons = document.querySelectorAll('#iconList li:not(.js-filter-hide)').length;
  el.textContent = `Showing ${visibleIcons} of ${allIcons.length} icons`;
}
