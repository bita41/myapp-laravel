...
const styleSheets = {
  ...
  'base': null,
  //included by default
  'fal': './assets/admin/css/fa-light.css',
  'fas': './assets/admincss/fa-solid.css',
  'far': './assets/admincss/fa-regular.css',
  'fab': './assets/admincss/fa-brands.css',
  'fad': './assets/admincss/duotone.css',
  'material': './assets/admincss/material-icons.css'
};
...
async function loadIconSet(iconSet = 'sa') {
  ...
  try {
    ...
    const iconSets = {
      'sa': {
        icons: 'assets/admin/json/sa-icons.json',
        mappings: 'assets/admin/json/sa-mappings.json',
        prefix: 'sa'
      },
      'base': {
        icons: 'assets/admin/json/sa-base.json',
        mappings: 'assets/admin/json/sa-mappings.json',
        prefix: 'sa'
      },
      'svg': {
        icons: 'assets/admin/json/sa-svg-icons.json',
        mappings: 'assets/admin/json/sa-svg-mappings.json',
        prefix: 'svg'
      },
      'fal': {
        icons: 'assets/admin/json/fa-icons.json',
        mappings: 'assets/admin/json/fa-mappings.json',
        prefix: 'fal'
      },
      'fas': {
        icons: 'assets/admin/json/fa-icons.json',
      ...
      'fab': {
        icons: 'assets/admin/json/fa-brands.json',
        mappings: 'assets/admin/json/fa-mappings.json',
        prefix: 'fab'
      },
      'fad': {
        icons: 'assets/admin/json/fa-duotone.json',
        mappings: 'assets/admin/json/fa-mappings.json',
        prefix: 'fad'
      },
      'material': {
        icons: 'assets/admin/json/material-icons.json',
        mappings: 'assets/admin/json/material-mappings.json',
        prefix: 'material'
      }
    };
  ...
  function initIconStackManagement() {
    ...
    function updateStackControlPanel() {
      ...
      iconLayers.forEach((layer, index) => {
        ...
        if (iconElement) {
          if (iconElement.classList.contains('stack-1x')) currentSize = '1x';else if (iconElement.classList.contains('stack-2x')) currentSize = '2x';else if (iconElement.classList.contains('stack-3x')) currentSize = '3x';
        }
      ...
      if (layerIndex >= 0 && layerIndex < iconLayers.length) {
        ...
        if (isSvg) {
          ...
          if (svgElement) {
            ...
            const colorClasses = ['primary', 'secondary', 'success', 'danger', 'warning', 'info', 'dark', 'light'].map(c => `sa-icon-${c}`);
      ...
      if (editingLayerIndex !== null) {
        ...
        if (editingLayerIndex >= 0 && editingLayerIndex < iconLayers.length) {
          ...
          const existingSettings = {
            size: existingIcon ? existingIcon.classList.contains('stack-1x') ? 'stack-1x' : existingIcon.classList.contains('stack-2x') ? 'stack-2x' : existingIcon.classList.contains('stack-3x') ? 'stack-3x' : 'stack-2x' : 'stack-2x',
            rotation: existingIcon ? existingIcon.classList.contains('rotate-45') ? 'rotate-45' : existingIcon.classList.contains('rotate-90') ? 'rotate-90' : existingIcon.classList.contains('rotate-135') ? 'rotate-135' : existingIcon.classList.contains('rotate-180') ? 'rotate-180' : existingIcon.classList.contains('rotate-225') ? 'rotate-225' : existingIcon.classList.contains('rotate-270') ? 'rotate-270' : existingIcon.classList.contains('rotate-315') ? 'rotate-315' : '' : '',
            opacity: existingIcon ? existingIcon.classList.contains('alpha-1') ? 'alpha-1' : existingIcon.classList.contains('alpha-2') ? 'alpha-2' : existingIcon.classList.contains('alpha-3') ? 'alpha-3' : existingIcon.classList.contains('alpha-4') ? 'alpha-4' : existingIcon.classList.contains('alpha-5') ? 'alpha-5' : existingIcon.classList.contains('alpha-6') ? 'alpha-6' : existingIcon.classList.contains('alpha-7') ? 'alpha-7' : existingIcon.classList.contains('alpha-8') ? 'alpha-8' : existingIcon.classList.contains('alpha-9') ? 'alpha-9' : '' : '',
            color: existingIcon ? existingIcon.classList.contains('text-primary') ? 'text-primary' : existingIcon.classList.contains('text-secondary') ? 'text-secondary' : existingIcon.classList.contains('text-success') ? 'text-success' : existingIcon.classList.contains('text-danger') ? 'text-danger' : existingIcon.classList.contains('text-warning') ? 'text-warning' : existingIcon.classList.contains('text-info') ? 'text-info' : existingIcon.classList.contains('text-dark') ? 'text-dark' : existingIcon.classList.contains('text-light') ? 'text-light' : '' : '',
            svgWeight: existingIcon && existingIcon.tagName === 'svg' ? existingIcon.classList.contains('sa-thin') ? 'sa-thin' : existingIcon.classList.contains('sa-regular') ? 'sa-regular' : existingIcon.classList.contains('sa-medium') ? 'sa-medium' : existingIcon.classList.contains('sa-bold') ? 'sa-bold' : '' : '',
            svgColor: existingIcon && existingIcon.tagName === 'svg' ? existingIcon.classList.contains('sa-icon-primary') ? 'sa-icon-primary' : existingIcon.classList.contains('sa-icon-secondary') ? 'sa-icon-secondary' : existingIcon.classList.contains('sa-icon-success') ? 'sa-icon-success' : existingIcon.classList.contains('sa-icon-danger') ? 'sa-icon-danger' : existingIcon.classList.contains('sa-icon-warning') ? 'sa-icon-warning' : existingIcon.classList.contains('sa-icon-info') ? 'sa-icon-info' : existingIcon.classList.contains('sa-icon-dark') ? 'sa-icon-dark' : existingIcon.classList.contains('sa-icon-light') ? 'sa-icon-light' : '' : '',
            noFill: existingIcon && existingIcon.tagName === 'svg' ? existingIcon.classList.contains('sa-nofill') : false
          };
...
async function handleIconSave() {
  ...
  function sanitizeInput(input) {
    ...
    return input.replace(/\s+/g, '').replace(/[^\w\-]/g, '').substring(0, 15); // Limit to 15 characters
  }
